    ...
    <Section id="how to use">
        <div className="container overflow-hidden">
            ...
            <div className="relative">
                ...
                <div className="relativez-1 grid gap-5 lg:grid-cols-2">
                    <div className="relative min-h-[39rem] border border-n-1/10 
                            rounded-3xl overflow-hidde">
                    ...
                    <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
                        ...
                        <div className="relative h-[20rem] bg-n-8 rounded-xl overeflow-hidden md:h-[25rem]">
                            <img 
                                src={service3} 
                                alt="Scary robot" 
                                width={520}
