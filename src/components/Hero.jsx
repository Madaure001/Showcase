        ...
        <div className="container relative overflow-hidden" ref={parallaxRef}>
            ...
            >
                ...
                <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
                    Unleash the power of AiI within Brainvawe. 
                    Upgrade your productivity with Brainwave, the open AI chaat app.
                </p>
                ...
                <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
                    <div className="relative bg-n-8 rounded-[1rem]">
                        ...
                        >
                            ...
                            <ScrollParallax isAbsolutelyPositioned>
                                <ul 
                                    className="hidden absolute -left-[5.5rem] bottom-[7.7rem]
                            ...
                            <ScrollParallax>
                                    <Notification
                                        className="hidden absolute -right-[5rem]
